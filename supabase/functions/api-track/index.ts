...
serve(async (req) => {
  ...
  try {
    ...
    // 🔍 DEBUG: Log cta_text extraction
    console.log('🔍 CTA Text Extraction:', {
      received_cta_text_root: cta_text,
      received_metadata_cta_text: metadata?.cta_text,
      final_cta_text: finalCtaText,

-- Fix financial metrics view to proportionally distribute fixed costs across rented pages
...
WITH site_page_counts AS (
  -- Count how many rented pages each site has
  SELECT 
    site_id,
...
SELECT 
  ...
  -- FIX: Distribute fixed cost proportionally across rented pages
  (p.monthly_rent_value 
